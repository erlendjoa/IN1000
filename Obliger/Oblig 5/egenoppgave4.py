...
#Oppgavetekst: Lag en form for kortspill mot maskinen ved å ta inn filen "kortikortstokk.csv", 
# forså å lage en fungerende kortstokk.
...
def blackjack(saldo):
    ...
    fil = open("Obliger\Oblig 5\kortikortstokk.csv")        #åpning av fil, forså å legge hver kodelinje inn i en tom liste
    kortstokk = []
    for x in fil:
