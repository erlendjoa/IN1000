...
class Player():
    ...
    def load_moves(self, action_bar):
        ...
        if len(self._moves) == 1:
            self._ACTION_MOVES.append(ActionButton(0, self, (action_bar.x+20, action_bar.y+action_bar.height//10), action_bar.width*0.42, 50, self._moves[0]._color, [self._moves[0]._name, self._moves[0]._val], 6))
        if len(self._moves) == 2:
            self._ACTION_MOVES.append(ActionButton(0, self, (action_bar.x+20, action_bar.y+action_bar.height//10), action_bar.width*0.42, 50, self._moves[0]._color, [self._moves[0]._name, self._moves[0]._val], 6))
            self._ACTION_MOVES.append(ActionButton(1, self, (action_bar.x+action_bar.width//2+20, action_bar.y+action_bar.height//10), action_bar.width*0.42, 50, self._moves[1]._color, [self._moves[1]._name, self._moves[1]._val], 6))
        if len(self._moves) == 3:
            self._ACTION_MOVES.append(ActionButton(0, self, (action_bar.x+20, action_bar.y+action_bar.height//10), action_bar.width*0.42, 50, self._moves[0]._color, [self._moves[0]._name, self._moves[0]._val], 6))
            self._ACTION_MOVES.append(ActionButton(1, self, (action_bar.x+action_bar.width//2+20, action_bar.y+action_bar.height//10), action_bar.width*0.42, 50, self._moves[1]._color, [self._moves[1]._name, self._moves[1]._val], 6))
            self._ACTION_MOVES.append(ActionButton(2, self, (action_bar.x+20, action_bar.y+action_bar.height//10*6), action_bar.width*0.42, 50, self._moves[2]._color, [self._moves[2]._name, self._moves[2]._val], 6))
        if len(self._moves) == 4: 
            self._ACTION_MOVES.append(ActionButton(0, self, (action_bar.x+20, action_bar.y+action_bar.height//10), action_bar.width*0.42, 50, self._moves[0]._color, [self._moves[0]._name, self._moves[0]._val], 6))
            self._ACTION_MOVES.append(ActionButton(1, self, (action_bar.x+action_bar.width//2+20, action_bar.y+action_bar.height//10), action_bar.width*0.42, 50, self._moves[1]._color, [self._moves[1]._name, self._moves[1]._val], 6))
            self._ACTION_MOVES.append(ActionButton(2, self, (action_bar.x+20, action_bar.y+action_bar.height//10*6), action_bar.width*0.42, 50, self._moves[2]._color, [self._moves[2]._name, self._moves[2]._val], 6))
            self._ACTION_MOVES.append(ActionButton(3, self, (action_bar.x+action_bar.width//2+20, action_bar.y+action_bar.height//10*6), action_bar.width*0.42, 50, self._moves[3]._color, [self._moves[3]._name, self._moves[3]._val], 6))
