...
class Preset():
    ...
    def get_Turtwig(self, bool):
        turtwig = Player(["pokemonclone", "Assets", "turtwig.png"], self.check_side(bool), "Turtwig", "grass", 500)
        turtwig.set_move(self._rock_smash)
        turtwig.set_move(self._grass_knot)
        return turtwig
    def get_Piplup(self, bool):
        piplup = Player(["pokemonclone", "Assets", "piplup.png"], self.check_side(bool), "Piplup", "water", 500)
        piplup.set_move(self._bubble)
        return piplup
    def get_Charmander(self, bool):
        charmander = Player(["pokemonclone", "Assets", "charmander.png"], self.check_side(bool), "Charmander", "fire", 500)
